...
public class RAGController {
    ...
    //gpt의 text-embedding-ada-002, text-embedding-3-small 등을 사용해서
    //의미적으로 유사한 텍스트는 유사한 벡터로 변환을 시키는 모델
    @Autowired
    private EmbeddingModel embeddingModel;

    /*
    SpringAI의 vectorStore 인터페이스를 구현한 인메모리 벡터 스토어
    문서를 벡터로 변환하여 메모리에 저장하고, 유사도 검색을 수행
     */
    ...
    public Map<String, Object> ask(@RequestBody Map<String, String> request){
        ...
        try{
            ...
            String prompt = """
                    ...
                    문서에 없는 내용은 '해당 정보는 프론트에 문의 부탁드립니다.'라고 답변해줘.
                    \n\n[문서내용]\n
                    """ + context + "\n\n[질문]\n" + question;
